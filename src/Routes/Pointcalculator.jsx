...
export default function Pointcalculator(){
    ...
    return (
        <div className='page-container'>
            ...
            <h3 id='Explanation'>This is a program designed by PROTA 17222 for First tech challenge teams to be able to log and visualize scores</h3>
            <Pointcalcform onAddData={handleAddData} />
            <button onClick={handleClearData} id='clrdatabutton'>Clear ALL Data</button>
